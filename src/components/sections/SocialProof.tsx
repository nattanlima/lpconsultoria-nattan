...
const TestimonialCard = ({ name, role, content, result, delay }: { name: string, role: string, content: string, result: string, delay: number }) => (
    <motion.div
        ...
        className="glass p-10 rounded-[2rem] border-primary/10 hover:border-primary/30 transition-all duration-500 flex flex-col group relative overflow-hidden"
    >
        ...
        <div className="flex items-center gap-4 mb-8">
            <div className="h-16 w-16 rounded-2xl border border-primary/20 p-1 shrink-0 bg-background-alt overflow-hidden">
                <div className="h-full w-full rounded-xl bg-primary/5 flex items-center justify-center text-sm text-primary font-m-black uppercase">
    ...
    return (
        <section className="py-32 bg-background relative overflow-hidden">
            ...
            <div className="container px-6 mx-auto">
                <div className="text-center max-w-3xl mx-auto mb-20">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-m-black text-text-primary mb-6 tracking-tight">
                            Histórias de quem <span className="text-primary italic">destravou</span>
                        </h2>
                ...
                {/* Community Prints stylized slots */}
                <motion.div
                ...
                >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
                        {[1, 2, 3, 4].map(i => (
                            <div key={i} className="aspect-[3/4] glass rounded-2xl border-white/5 flex flex-col items-center justify-center p-6 grayscale hover:grayscale-0 transition-all duration-700 opacity-30 hover:opacity-100">
